...
# Ensure sandbox/llama_cpp_repo and gguf-py are in sys.path for conversion modules
repo_dir = Path(__file__).parent / 'sandbox' / 'llama_cpp_repo'
if repo_dir.exists():
    sys.path.insert(0, str(repo_dir))
    sys.path.insert(1, str(repo_dir / 'gguf-py'))
...
try:
    ...
    # Try importing from sandbox/llama_cpp_repo
    sys.path.insert(0, str(Path(__file__).parent / 'sandbox' / 'llama_cpp_repo'))
    import gguf
